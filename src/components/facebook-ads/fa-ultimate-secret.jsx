      ...
      <div className="skew-y-[2deg] py-16">
          <MaxWidthWrapper className={"border-white"}>
            ...
            <div className="w-full lg:w-[80%] justify-self-center px-4 py-10 font-myFont">
              ...
              <p className='font-bold'>Facebook Ads are not just ads.</p> They’re your business’s front-row seat to billions of potential customers. Here’s how we make them work for you: 👉
              </div>
