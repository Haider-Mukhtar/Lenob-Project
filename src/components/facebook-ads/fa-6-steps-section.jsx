        ...
        <LeftSideVerticalText text={"6 Approach"} className="bg-myLightGray -left-11" />
          <div className="w-full lg:w-[80%] justify-self-center px-2 py-10 font-myFont">
            ...
            <div className='justify-self-center my-10'>
              <img className='object-cover h-24' src={FacebookPartner} alt='Facebook-partner-image' />
            </div>
            <p className="text-lg/8 md:text-xl/10 text-myWhite text-center">Here's how we turn ordinary campaigns into extraordinary results:</p>
            {/*Desktop*/}
            <div className='w-full lg:w-[80%] justify-self-center text-myBlack font-myFont mt-10 hidden lg:block'>
              <div className='flex  justify-self-start'>
                ...
                <img className='mt-14 h-36' src={RightPath} />
              </div>
              <div className='flex justify-end'>
                <img className='mt-14 h-36' src={LeftPath} />
                <div className='bg-mySteps flex gap-4 w-[60%] p-4 rounded-xl h-fit'>
                  <img className='h-16 object-cover' src={DotIcon} alt='Dot-Icon' />
                  <div className='text-lg/8 md:text-xl/10'>
