    ...
    <MaxWidthWrapper>
      <div className="w-full lg:w-[70%] justify-self-center border border-red-600 px-2">
          ...
          <div className="font-myFont text-myBlack font-semibold text-lg/8 md:text-xl/9">
            ...
            <p className="mt-10">If you're here, it's because you already know the power of Facebook. With over 2.9 billion active users scrolling, liking, and sharing every month, your audience is there.</p>
            <p className="mt-10">The real question is—are they seeing your brand?</p>
            ...
            <p className="mt-10">We've seen it all:</p>
            {[
