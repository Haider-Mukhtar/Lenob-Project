      ...
      <MaxWidthWrapper>
        <div className="w-full lg:w-[80%] pt-12 space-y-12 justify-self-center border border-red-600 -skew-y-3 px-2 pb-40">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-10">
            <div className="bg-myPrimary border-2 border-myPrimary text-lg md:text-xl font-myFont font-semibold px-6 py-3 rounded-xl text-myBlack hover:bg-transparent hover:text-myPrimary transition-all duration-300">
              Get a Free Audit Report
            </div>
            <div className="bg-transparent border-2 border-myPrimary text-lg md:text-xl font-myFont font-semibold px-6 py-3 rounded-xl text-myPrimary hover:bg-myPrimary hover:text-myBlack transition-all duration-300">
