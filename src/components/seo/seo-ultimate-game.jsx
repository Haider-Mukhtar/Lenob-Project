      ...
      <div className="skew-y-[2deg] py-16">
          <MaxWidthWrapper className={"border-white"}>
            ...
            <div className="w-full lg:w-[80%] justify-self-center border border-red-600 px-4 py-10 font-myFont">
              ...
              <div className="w-80 md:w-[400px] my-10 mx-2 h-[350px] rounded-4xl text-myWhite font-myFont overflow-hidden bg-myGrowthCard1 hover:scale-105 transition-transform duration-300">
                ...
                <div className="w-80 md:w-[400px] my-10 mx-2 h-[350px] rounded-4xl text-myWhite font-myFont overflow-hidden bg-myGrowthCard2 hover:scale-105 transition-transform duration-300">
                <div className="px-8 py-6 space-y-4 text-myWhite">
                <div className="text-xl md:text-2xl font-bold text-myWhite mb-8">
                ...
                <div className="w-80 md:w-[400px] my-10 mx-2 h-[350px] rounded-4xl text-myWhite font-myFont overflow-hidden bg-myGrowthCard3 hover:scale-105 transition-transform duration-300">
                <div className="px-8 py-6 space-y-4 text-myWhite">
                <div className="text-xl md:text-2xl font-bold text-myWhite mb-8">
                ...
                <div className="w-80 md:w-[400px] my-10 mx-2 h-[350px] rounded-4xl text-myWhite font-myFont overflow-hidden bg-myGrowthCard4 hover:scale-105 transition-transform duration-300">
                <div className="px-8 py-6 space-y-4 text-myWhite">
                <div className="text-xl md:text-2xl font-bold text-myWhite mb-8">
