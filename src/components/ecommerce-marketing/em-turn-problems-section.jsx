...
const EMTurnProblemsSection = () => {
  return (
    ...
    <div className="w-full lg:w-[80%] justify-self-center px-4 py-10 font-myFont">
      ...
      <div className="font-myFont text-xl md:text-3xl text-center md:mx-12 text-myBlack my-10">
      At Lenob.co, we flip these challenges into opportunities for growth
      </div>
      <Marquee pauseOnHover >
      <div className="w-80 md:w-[400px] my-2 mx-2 h-[260px] rounded-4xl text-myBlack font-myFont overflow-hidden bg-myVeryLightGray hover:scale-105 transition-transform duration-300">
