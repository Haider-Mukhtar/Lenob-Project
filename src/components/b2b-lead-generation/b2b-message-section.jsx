  ...
  return (
    ...
    <MaxWidthWrapper>
      <div className="w-full lg:w-[60%] justify-self-center px-2">
          <p className="font-myFont text-xl/8 md:text-4xl/14 font-bold text-myBlack text-center">Dear Business Owners,</p>
          <div className="font-myFont text-myBlack font-medium text-lg/8 md:text-xl/10">
          <p className="mt-8">We get it. Running a business is tough. You’re pouring your time and resources into finding the right leads, only to be met with endless frustration—calls that don’t get answered, emails left unopened, and ads that don’t seem to deliver.</p>
            <p className="mt-8 font-bold">But picture this:</p>
            <p className="mt-8">What if every ad you ran delivered sales-ready prospects straight to your inbox?</p>
            ...
            <p className="mt-8 font-bold">The Next Step: ITS RIGHT BELOW 👇</p>
          </div>
